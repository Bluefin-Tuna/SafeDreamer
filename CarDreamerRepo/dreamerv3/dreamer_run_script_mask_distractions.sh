...
# bash train_dm3.sh 2000 0 --task carla_right_turn_simple --dreamerv3.logdir ./logdir/carla_right_turn_simple_bev --dreamerv3.run.steps 200000
# bash train_dm3.sh 2000 0 --task carla_stop_sign --dreamerv3.logdir ./logdir/carla_stop_sign_bev_pixel --dreamerv3.run.steps 100000
bash train_mask.sh 2000 0 --task carla_four_lane --dreamerv3.logdir ./logdir/carla_four_lane_bev_distractions --dreamerv3.run.steps 270000
# Example 1: Use default settings to train an agent
