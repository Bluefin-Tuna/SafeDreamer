...
def parse_args():
    ...
    parser.add_argument('--encoder', default='vit', type=str, choices=['cnn', 'vit'], help='either `cnn` or `vit`. ViT only implemented for MaDi and SVEA.')
    ...
    # New args for CARLA + DreamerV3
    parser.add_argument("--env.world.carla_port", type=int, default=2000)
    parser.add_argument("--dreamerv3.jax.policy_devices", type=int, default=0)
    parser.add_argument("--dreamerv3.jax.train_devices", type=int, default=0)
    parser.add_argument("--dreamerv3.logdir", type=str, default="./logdir")
    parser.add_argument("--dreamerv3.run.steps", type=int, default=1000000)
