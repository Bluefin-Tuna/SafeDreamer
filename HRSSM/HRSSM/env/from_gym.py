...
class FromGym(base.Env):
    ...
    def obs_space(self):
        ...
        return {
            **spaces,
            "reward": base.Space(np.float32),
            "is_first": base.Space(bool),
            "is_last": base.Space(bool),
            "is_terminal": base.Space(bool),
        }
    ...
    def _convert(self, space):
        if hasattr(space, "n"):
            return base.Space(np.int32, (), 0, space.n)
        return base.Space(space.dtype, space.shape, space.low, space.high)
